...
#define IREGFILE_SIZE (52 * sizeof(uint64_t))
#define IREGFILE                                                                                                                                \
...
#define FPREGFILE_SIZE (48 * 3 * sizeof(uint32_t))
#define FPREGFILE                                                                                                                                                 \
...
#define FPREGFILE_SIZE (60 * 3 * sizeof(uint32_t))
#define FPREGFILE                                                                                                                                                 \
  TestHarness__DOT__chiptop__DOT__system__DOT__tile_prci_domain__DOT__tile_reset_domain__DOT__boom_tile__DOT__core__DOT__fp_pipeline__DOT__fregfile__DOT__regfile \
      .m_storage
#endif
